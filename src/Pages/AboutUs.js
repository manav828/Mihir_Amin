...
// import BrandingHero from "./service.js";
// import BrandingLogo from "./scrollLogo.js";
...
//               Yogi Kidar <span>Founder @ Reeco</span>
//             </p>
//             <p className="testimonial-company">Reeco</p>
//           </div>
//         </section>
...
function AboutUsPage() {
  ...
  return (
    <>
      {/* Add smooth scrolling behavior and fix whitespace issue */}
      <style>
        {`
          html {
            scroll-behavior: smooth;
          ...
          /* Fix whitespace issue on smaller screens */
          @media (max-width: 768px) {
            .main {
              width: 100% !important; /* Stretch to full width on mobile */
              margin: 0 !important; /* Remove auto margins to fill viewport */
              padding: 40px 15px !important; /* Adjust padding for consistency */
            }
            .about-hero .row.container {
              width: 100% !important; /* Stretch Bootstrap container to full width */
              max-width: 100% !important; /* Remove fixed max-width */
